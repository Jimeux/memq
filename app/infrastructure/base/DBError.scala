...
object DBError {
  ...
  def apply(e: Exception): DBError = e match {
...
final case class NotFoundError() extends DBError

final case class UniqueViolationError(field: String) extends DBError

final case class UnhandledDBError() extends DBError

final case class ConnectionError() extends DBError
